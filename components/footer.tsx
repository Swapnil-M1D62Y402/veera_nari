    ...
    <footer className="border-t">
      <div className="container flex flex-col gap-8 py-8 md:flex-row md:py-12">
        <div className="flex-1 space-y-4">
          <h2 className="font-bold">Veera Nari</h2>
          <p className="text-sm text-muted-foreground">Pioneering women safety for the digital age.</p>
        </div>
        <div className="grid flex-1 grid-cols-2 gap-12 sm:grid-cols-3">
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/consult" className="text-muted-foreground transition-colors hover:text-primary">
                  Consult Specialists
                </Link>
              </li>
            </ul>
